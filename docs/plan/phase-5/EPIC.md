...
| P5-T02 | Add LLM provider abstraction | In progress | 2026-05-27 | Next active task |
| P5-T03 | Build end-to-end answer generation API | Not started | - | Pending |
| P5-T04 | Add deterministic citation mapping | Not started | - | Pending |
| P5-T05 | Add refusal and ambiguity handling | Not started | - | Pending |
| P5-T06 | Add grounded-response regression tests | Not started | - | Pending |
| P5-T07 | Add usage, latency, and confidence logging | Not started | - | Pending |
